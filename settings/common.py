...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/ookami/ws/xml_generator/db',                      # Or path to database file if using sqlite3.
...
import os
GLOBAL_PATH = os.path.dirname( globals()[ '__file__' ] ) + '/data'
...
MEDIA_ROOT = '/home/ookami/ws/xml_generator/media/'
...
STATIC_ROOT = '/home/ookami/ws/xml_generator/static/'
...
MIDDLEWARE_CLASSES = (
    ...
    'xml_generator.middleware.AllowCrossDomainMiddleware',
