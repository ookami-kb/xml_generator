...
class CustomIndexDashboard(Dashboard):
    """
    Custom index dashboard for xml_generator.
    """
    def init_with_context(self, context):
        ...
        self.children.append(modules.RecentActions(_(u'Последние действия'), 5))
...
class CustomAppIndexDashboard(AppIndexDashboard):
    """
    Custom app index dashboard for xml_generator.
    """
